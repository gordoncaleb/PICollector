...
public class SchoolSiteLocatorAPI {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("Best candidate location: x:" + loc[0] + " y:" + loc[1]);
			...
			resp = locator.queryForSchoolInfo(schoolCodes.values());
	...
	public Map<String, Object> findAddressCandidates(PhysicalAddress addr) throws JsonParseException, JsonMappingException, IOException,
			URISyntaxException {

		String street = addr.getHouseNumber() + " " + addr.getStreetName() + " " + addr.getMode();
		...
		String uri = "http://maps.schoolsitelocator.com/ArcGIS/rest/services/geocodeServices/newhanover/GeocodeServer/findAddressCandidates?Street="
				+ street + "&f=json&outSR={\"wkid\":102100}&outFields=*";
	...
	public String[] getBestCandidateLocation(Map<String, Object> candidates) throws Exception {
		...
		if (list instanceof List<?>) {
			...
			for (Object c : (List<?>) list) {
				...
				if (c instanceof Map<?, ?>) {
					...
					try {
						Double score = Double.parseDouble(cand.get("score").toString());
	...
	public Map<String, Object> queryForSchoolCode(String x, String y) throws URISyntaxException, IOException {
	...
	public Map<String, String> getSchoolCodes(Map<String, Object> queryResp) throws Exception {

		List<Map<String, Object>> features = (List<Map<String, Object>>) JSON.getElement(queryResp, "features");

		if (!features.isEmpty()) {

			Map<String, Object> attribs = (Map<String, Object>) features.get(0).get("attributes");

			Map<String, String> schoolCodes = new HashMap<String, String>();

			schoolCodes.put("ELEM", attribs.get("ELEM_").toString());
			schoolCodes.put("INT", attribs.get("INT_").toString());
			schoolCodes.put("HIGH", attribs.get("HIGH_").toString());
	...
	public Map<String, Object> queryForSchoolInfo(Collection<String> schoolCodes) throws URISyntaxException, IOException {
	...
	public List<School> parseSchoolObject(Map<String, Object> schoolInfos) throws Exception {
		List<Map<String, Object>> features = (List<Map<String, Object>>) JSON.getElement(schoolInfos, "features");

		List<School> schools = new ArrayList<School>();

		for (Map<String, Object> feat : features) {

			Map<String, Object> attribs = (Map<String, Object>) feat.get("attributes");
