...
public class JSON {
	...
	public static Object getElement(Map<String, Object> map, String... path)
			throws Exception {
		return getElement(map, 0, path);
	}

	private static Object getElement(Map<String, Object> map, int key,
			String... path) throws Exception {

		Object obj = map.get(path[key]);

		if (obj == null) {
			throw new Exception("Could not find path element: " + path[key]
					+ " in " + Arrays.toString(path) + " in map:"
					+ map.toString());
		}
